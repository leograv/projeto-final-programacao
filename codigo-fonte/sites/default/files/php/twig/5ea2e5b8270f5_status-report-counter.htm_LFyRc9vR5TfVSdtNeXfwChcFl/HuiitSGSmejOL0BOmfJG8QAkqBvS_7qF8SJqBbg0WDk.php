...
class __TwigTemplate_d634da20d67f81687fc5a4e4bd4eb881a8c474550378431e37ba135567edf7b4 extends \Twig\Template
{
...
($context["severity"] ?? null)))];
  ...
  <span class=\"system-status-counter__status-icon system-status-counter__status-icon--";
        // line 21
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["severity"] ?? null)), "html", null, true));
        echo "\"></span>
  <span class=\"system-status-counter__status-title\">
    <span class=\"system-status-counter__title-count\">";
        // line 23
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["amount"] ?? null)), "html", null, true));
        echo " ";
...
";
    ...
    {
        return new Source("", "core/themes/seven/templates/status-report-counter.html.twig", "/home/liveleit/public_html/core/themes/seven/templates/status-report-counter.html.twig");
    }
}
