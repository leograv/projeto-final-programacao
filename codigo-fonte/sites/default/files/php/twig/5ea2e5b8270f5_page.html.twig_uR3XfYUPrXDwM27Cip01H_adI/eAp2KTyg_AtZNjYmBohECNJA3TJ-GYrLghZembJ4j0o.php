...
class __TwigTemplate_04b0553cf94b6227411affaa851ffa64392c33c142adc934df9899dad706066d extends \Twig\Template
{
...
($context["theme"] ?? null), "settings", []), "navbar_position", [])) ? (("navbar-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["theme"] ?? null), "settings", []), "navbar_position", []))))) : (($context["container"] ?? null)))];
      ...
      ";
        ...
        if ($this->getAttribute(($context["page"] ?? null), "navigation_collapsible", [])) {
            ...
            <span class=\"sr-only\">";
            // line 74
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Toggle navigation")));
            echo "</span>
      ...
      ";
        ...
        if ($this->getAttribute(($context["page"] ?? null), "navigation_collapsible", [])) {
          ...
          ";
            // line 85
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["page"] ?? null), "navigation_collapsible", [])), "html", null, true));
            echo "
        </div>
      ";
        }
...
";
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/system/page.html.twig", "/home/liveleit/public_html/themes/bootstrap/templates/system/page.html.twig");
    }
}
